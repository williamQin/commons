...
public class HttpUtil {
	...
	public static void download(String urlStr, String fileName) throws Exception {
		...
		System.err.println(httpconn.getContent().toString());
	...
	public static void main(String[] args) throws Exception {
		InputStream in = download("http://bw.wcd.qq.com/newsInfo/getIncPkg.html?cycle=0&mac=E0:CB:4E:AB:8D:FF&v=2000000000");
		FileUtil.writeFile(in, "d:/1.tar");
	}
